...
#
# Resources: Dr. Pence and Runestone and GeeksforGeeks for reverse method
####################################
...
class DoublyLinkedList:
    ...
    def reverse(self):
        size = self.size()
        # if size != 0 or size !=1:  ###previous code, I was having a tough time updating the previous instance variable.
        #     last = self.tail
        #     current = self.tail
        #     new=self.tail
        #     while current != None:
