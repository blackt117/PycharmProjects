...
for x in names:
    print(x)
print('Tried to pop the list with a negative integer, should give Invalid Input:',names.pop(-1))
print()
## Testing more cases
...
print('\nCreated a new DLL, named numbers, Added 8 then 9 and appended 10')
numbers.add(8)
numbers.add(9)
numbers.append(10)
print('Numbers was reversed, order should be 10,8,9:')
numbers.reverse()
for x in numbers:
    print(x)
print('Head should be 10:',numbers.head)
print('Tail should be 9:',numbers.tail)
print('\nAdded 11 to the list and reversed again')
numbers.add(11)
numbers.reverse()
print('Order should be 9,8,10,11:')
for x in numbers:
    print(x)
print()
print('Head should be 9:',numbers.head)
print('Tail should be 11:',numbers.tail)
numbers.remove(9)
numbers.remove(11)
numbers.remove(8)
print('\nRemoved 9,11, and 8. Then reversed the list again')
numbers.reverse()
print('Numbers in order should be 10. (There\'s no change for DLL with size 1)')
for x in numbers:
    print(x)
print('Same with DLL with size 0, Removed 10 and reversed the list again.')
print('There are no numbers in the list so there should be no output when asked to print each index in list')
numbers.remove(10)
numbers.reverse()
for x in numbers:
    print(x)
