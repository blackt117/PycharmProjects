...
# References: Dr. Pence, Prior Knowledge, and Andrew Davison
#===========================================
...
def main():
    ...
    sem = input('Is this your first semester (y/n)? ')
    while sem not in ('Y', 'N', 'n', 'y'):
        sem = input("Invalid Input, Please Enter (y/n) ")
